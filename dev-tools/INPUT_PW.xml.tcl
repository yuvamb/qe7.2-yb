...
"PRB 84, 115108 (2011)".
      ...
      help starting_ns_eigenvalue {
      <ul>
<li> <em>Variables: </em><big><b>starting_ns_eigenvalue(m,ispin,ityp), (m,ispin,ityp) = (1,1,1) ... (2*lmax+1,nspin or npol,ntyp)</b></big>
</li>
<br><li> <em>Type: </em>REAL</li>
<br><li> <em>Default: </em> -1.d0 that means NOT SET
         </li>
<br><li> <em>Description:</em>
</li>
<blockquote><pre>
...
"angle2" variables for atomic type 1
      ...
      help constrained_magnetization {
      <ul>
...
This is only for Laue-RISM and "laue_wall" /= 'none' .
      ...
      help ATOMIC_SPECIES_flags {
      <h2>Description of ATOMIC_SPECIES card's flags</h2>
      }
...
half a grid step in the corresponding direction ).
      ...
      help ADDITIONAL_K_POINTS_flags {
...
Crystal lattice vectors (in cartesian axis):
    ...
    v3(1)  v3(2)  v3(3)    ... 3rd lattice vector
      ...
      help CONSTRAINTS_flags {
      <h2>Description of CONSTRAINTS card's flags</h2>
      }
...
This variable is optional.
      ...
      help OCCUPATIONS_flags {
      <h2>Description of OCCUPATIONS card's flags</h2>
      }
    
    help occupations_table {
    <ul>
...
To be specified only for spin-polarized calculations.
      ...
      help ATOMIC_VELOCITIES_flags {
      <h2>Description of ATOMIC_VELOCITIES card's flags</h2>
      }
    
    help atomic_velocities {
    <ul>
...
<blockquote><pre> atomic velocities along x y and z direction
      ...
      help ATOMIC_FORCES_flags {
      <h2>Description of ATOMIC_FORCES card's flags</h2>
      }
...
<li> <em>Variable: </em><big><b>Density</b></big>
</li>
<br><li> <em>Type: </em>REAL</li>
<br><li> <em>Description:</em>
</li>
...
<li> <em>Variable: </em><big><b>Molecule</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER</li>
<br><li> <em>Description:</em>
</li>
...
<li> <em>Variable: </em><big><b>Density_Left</b></big>
</li>
<br><li> <em>Type: </em>REAL</li>
<br><li> <em>Description:</em>
</li>
...
<li> <em>Variable: </em><big><b>Density_Right</b></big>
</li>
<br><li> <em>Type: </em>REAL</li>
<br><li> <em>Description:</em>
</li>
...
U, J0, J, B, E2, E3, V in the HUBBARD card.
    ...
    <ul>
<li> <em>Variables: </em><big><b>label(1)-manifold(1), u_val(1)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER-LITERAL, CHARACTER, REAL</li>
<br><li> <em>Description:</em>
</li>
<blockquote><pre>
<b>Syntax:</b>
...
<i>label</i>    = label of the atom (as defined in "ATOMIC_SPECIES")
...
HUBBARD (ortho-atomic)
  ...
  U Ni-3d 6.0
    ...
    grouphelp {
    label(1)-manifold(1) j0_val(1) 
    } {
    <ul>
<li> <em>Variables: </em><big><b>label(1)-manifold(1), j0_val(1)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER-LITERAL, CHARACTER, REAL</li>
<br><li> <em>Description:</em>
</li>
...
<b>Example:</b>
  ...
  J0 Ni-3d 1.2
    ...
    <ul>
<li> <em>Variables: </em><big><b>paramType(1), label(1)-manifold(1), paramValue(1)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER, CHARACTER, REAL</li>
<br><li> <em>Description:</em>
</li>
<blockquote><pre>
...
<b>Example:</b>
  ...
  B Ni-3d 1.3
    ...
    grouphelp {
    label(I)-manifold(I) u_val(I) 
    } {
    <ul>
<li> <em>Variables: </em><big><b>label(I)-manifold(I), u_val(I)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER, REAL</li>
<br><li> <em>Description:</em>
</li>
<blockquote><pre>
<b>Syntax</b> of the line:
...
<i>u_val</i>    = value of the <i>U</i> parameter (in eV)
    ...
    grouphelp {
    label(I)-manifold(I) j0_val(I) 
    } {
    <ul>
<li> <em>Variables: </em><big><b>label(I)-manifold(I), j0_val(I)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER, REAL</li>
<br><li> <em>Description:</em>
</li>
...
<i>j0_val</i>   = value of the <i>J0</i> parameter (in eV)
    ...
    grouphelp {
    label(I)-manifold(I) label(J)-manifold(J) I J v_val(I,J) 
    } {
    <ul>
<li> <em>Variables: </em><big><b>label(I)-manifold(I), label(J)-manifold(J), I, J, v_val(I,J)</b></big>
</li>
<br><li> <em>Type: </em>CHARACTER, CHARACTER, INTEGER, INTEGER, REAL</li>
<br><li> <em>Description:</em>
</li>
<blockquote><pre>
<b>Syntax</b> of the line:
...
<i>label(I)</i>    = label of the atom <i>I</i> (as defined in "ATOMIC_SPECIES")
<i>manifold(I)</i> = specs of the manifold for atom <i>I</i> (e.g., 3d, 2p...)
<i>label(J)</i>    = label of the atom <i>J</i> (as defined in "ATOMIC_SPECIES")
